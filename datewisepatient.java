   ...
   class ppreport extends JFrame implements ActionListener
{
	JLabel l0,l1,l2;
	JButton b1,btnBack;
	JComboBox c1;
	...
	public ppreport()
	{
           		...
           		try
		{
			...
			rs=st.executeQuery("select distinct(date) from patientinfo");
                                      		if(rs==null)
		...
		//String cname,bdate;
		  try
		  {
		   PreparedStatement pst=con.prepareStatement("select * from patientinfo where date='"+from+"' " );
	           rs=pst.executeQuery();
