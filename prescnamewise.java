   ...
   class prescnamerep extends JFrame implements ActionListener
{
	JLabel l0,l1,l2;
	JButton b1,btnBack;
	JComboBox c1;
	...
	public prescnamerep()
	{
           		...
           		try
		{
			...
			rs=st.executeQuery("select distinct(patientname) from prescription");
                                      		if(rs==null)
		...
		//String cname,bdate;
		  try
		  {
		   PreparedStatement pst=con.prepareStatement("select * from prescription where patientname='"+from+"' " );
	           rs=pst.executeQuery();
